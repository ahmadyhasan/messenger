...
"""
from django.conf import settings  # اضافه کردن این خط برای ایمپورت settings
...
urlpatterns = [
    ...
    path('api/chat/', include('chat.urls')),  # اضافه کردن URLهای چت
...
# اضافه کردن مسیر فایل‌های رسانه‌ای
if settings.DEBUG:
